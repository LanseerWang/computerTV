...
def mouse_control(command):
    if command['action'] == 'move':
        dxdy = json.loads(command['data'])
        mouse.move(dxdy['dx'], dxdy['dy'], absolute=False)
    elif command['action'] == 'left click':
        mouse.click()
    elif command['action'] == 'right click':
        mouse.right_click()
    elif command['action'] == 'double click':
        mouse.double_click()
